...
void evaluateTcpPacket(void) {
  ...
  sourcePort =      (((uint16_t)myreceivebuffer[54])<<8) +  myreceivebuffer[55];
  destinationPort = (((uint16_t)myreceivebuffer[56])<<8) +  myreceivebuffer[57];
  ...
  remoteSeqNr = 
        (((uint32_t)myreceivebuffer[58])<<24) +
        (((uint32_t)myreceivebuffer[59])<<16) +
        (((uint32_t)myreceivebuffer[60])<<8) +
        (((uint32_t)myreceivebuffer[61]));
  remoteAckNr = 
        (((uint32_t)myreceivebuffer[62])<<24) +
